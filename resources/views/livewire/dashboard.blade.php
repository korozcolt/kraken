                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <a target="_blank" href="{{ route('status.list',2) }}">
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-700">
                                        {{ $voterNotAnswerTotal }} - {{ round((($voterNotAnswerTotal)/($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                    </p>
                                </div>
                            </a>
                        </div>
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-700">
                                    {{ $voterBadWriteTotal }}  - {{ round((($voterBadWriteTotal)/($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                </p>
                            </div>
                            </a>
                        </div>
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-700">
                                    {{ $voterWrongNumberTotal }} - {{ round((($voterWrongNumberTotal) / ($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                </p>
                            </div>
                            </a>
                        </div>
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <a target="_blank" href="{{ route('status.list',0) }}">
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-700">
                                        {{ $voterNotAnswerCallOut }} - {{ round((($voterNotAnswerCallOut) / ($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                    </p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-700">
                                    {{ $voterOutRangeTotal }} - {{ round((($voterOutRangeTotal) / ($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                </p>
                            </div>
                            </a>
                        </div>
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-700">
                                    {{ $voterDontKnowTotal }} - {{ round((($voterDontKnowTotal) / ($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                </p>
                            </div>
                            </a>
                        </div>
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-700">
                                    {{ $voterVersusTotal }} - {{ round((($voterVersusTotal) / ($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                </p>
                            </div>
                            </a>
                        </div>
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-700">
                                    {{ $voterWhiteTotal }} - {{ round((($voterWhiteTotal) / ($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                </p>
                            </div>
                            </a>
                        </div>
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-700">
                                    {{ $voterRightTotal }} - {{ round((($voterRightTotal) / ($voterTotal - $voterNotCalledTotal))*100,1) }}%
                                </p>
                            </div>
                            </a>
                        </div>
